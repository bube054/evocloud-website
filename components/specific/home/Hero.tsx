...
export default function Hero() {
  ...
  return (
    <section className="relative h-max md:h-screen bg-cover bg-center px-4 py-6 md:px-4 md:py-12 flex items-center justify-center bg-linear-to-br from-accent to-primary text-background">
      {positions?.map((pos, i) => {
        return (
          <FaShield
            key={i}
