    ...
    <div className="flex items-center justify-center px-4 py-6 md:px-4 md:py-12">
      <div className="max-w-screen-xl w-full mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
          ...
          <P1 className="text-lg font-normal text-muted-foreground tracking-[0.128px] leading-relaxed lg:border-x lg:border-x-primary lg:px-4">
            <span className="font-bold text-primary">Kubernetes extended:{" "}</span>
